...
public final class RunCompleteMailer {
  ...
  // an issue where the BW server completed 200+ runs over a single weekend and
  // sent an email at the end of each run.  Obviously something was wrong with
  // the BW server for it to complete so many runs so quickly, but this
  ...
  private String prepareEmailBody(Results results,
    ...
    sb.append("Hello,\n");
    sb.append("\n");
    sb.append("A BW run has completed in this environment:\n");
    sb.append("\n");
    sb.append("  ");
    ...
    if (results.uuid() != null) {
      sb.append("Details: ");
      sb.append("https://bw-status.khulnasoft.com/results/");
    ...
    if (previousCommitId != null
      ...
      sb.append("https://github.com/KhulnaSoft/BenchWeb/compare/");
      sb.append(previousCommitId);
      sb.append("...");
      sb.append(newCommitId);
      sb.append("\n");
  ...
  public static String runCompleteEmailSubject(Results results) {
    ...
    return "<bw> <auto> Run complete: " + name;
  }
}
