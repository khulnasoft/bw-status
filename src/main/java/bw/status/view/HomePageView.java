...
public record HomePageView(ImmutableList<ResultsView> results,
   ...
   * @param completedFrameworks The number of frameworks that the plugins has
   ...
   * @param visualizeResultsUrl The BW website URL for visualizing the results
  ...
  public record ResultsView(
    ...
    // Provide backwards compatibility with the BW website, which reads the
