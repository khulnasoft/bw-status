 ...
 * in the main BW project's benchmark_config.json files.  For example, for the
 ...
 *        the BW website.  For example, the permutation named "aspnetcore-mw"
 ...
 *        BW website, or "None" or the empty string if there is no suitable
